 ...
 * Generated for Laravel 5.8 on 2019-06-11 08:25:03.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Queue {
        ...
        {
                        return \Illuminate\Support\Facades\Queue::fake();
        }
        ...
        public static function resolved($callback)
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        \Illuminate\Support\Facades\Queue::resolved($callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        return \Illuminate\Support\Facades\Queue::spy();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        return \Illuminate\Support\Facades\Queue::shouldReceive();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        \Illuminate\Support\Facades\Queue::swap($instance);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        return \Illuminate\Support\Facades\Queue::getFacadeRoot();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        \Illuminate\Support\Facades\Queue::clearResolvedInstance($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        return \Illuminate\Support\Facades\Queue::getFacadeApplication();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Facades\Facade            
                        \Illuminate\Support\Facades\Queue::setFacadeApplication($app);
        }
         ...
         * @static 
         */ 
        public static function connection($value = null)
        {
                        /** @var \Illuminate\Support\Testing\Fakes\QueueFake $instance */
                        return $instance->connection($value);
        }
